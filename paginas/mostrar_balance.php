...
<body>
    <div class="container">
        <div class="title-container">
             <h2 class="text-center">Reporte Mensual <span><?= $inicioMes ?> / <?= $finMes ?></span></h2>
        </div>
        ...
        <div class="table-container">
            ...
            <h4 class="balance-text">Balance Mensual: $<?php echo $balance; ?></h4>
        </div>

        <!--Contenedor del gráfico-->
        <div class="chart-container">

            <h4 class="chart-title">Gráfico de balance mensual Entradas vs Salidas</h4>
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ['#0040b6ff', '#df0000ff'],
                    borderColor: ['#0040b6ff', '#df0000ff'],
                    borderWidth: 1
                }]
            },
            options: {
